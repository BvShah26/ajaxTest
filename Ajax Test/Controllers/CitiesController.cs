...
namespace Ajax_Test.Controllers
{
    public class CitiesController : Controller
    {
        ...
        {
            var applicationDBContext = _context.TblCity.Include(c => c.State);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var city = await _context.TblCity
                .Include(c => c.State)
        ...
        {
            ViewData["StateId"] = new SelectList(_context.TblState, "Id", "StateName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CityName,StateId")] City city)
        {
            ...
            ViewData["StateId"] = new SelectList(_context.TblState, "Id", "Id", city.StateId);
            return View(city);
        }
        ...
        {
            return _context.TblCity.Any(e => e.Id == id);
        }
    }
}
